//package com.devsu.banking.person_customer.r2dbc;
//
...
//        when(repository.findById(uuid)).thenReturn(Mono.just("test"));
//        when(mapper.map("test", Object.class)).thenReturn("test");
//
//        Mono<Object> result = repositoryAdapter.findById(uuid);
//
